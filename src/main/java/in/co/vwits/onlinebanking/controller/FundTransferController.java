...
public class FundTransferController {
	...
	//Transferring of Money
		...
		public Transaction addTransaction(@PathVariable("toAccNo") int toAccNo ,@PathVariable("fromAccNo") int fromAccNo, @RequestBody Transaction tran,@PathVariable("transPassword")String transPassword) {
